package com.neosukisu.neosukisu.data.settings
...
import com.neosukisu.neosukisu.domain.model.AppearanceSetting
import com.neosukisu.neosukisu.domain.model.PlatformFeatureStatus
import com.neosukisu.neosukisu.domain.model.PlatformSetting
import com.neosukisu.neosukisu.domain.model.SettingsPlatformSnapshot
import com.neosukisu.neosukisu.magica.BootCompletedReceiver
...
class SettingsPlatformRepository(
    ...
    private fun toggleLauncherIcon(useAlt: Boolean) {
        ...
        val main = ComponentName(packageName, "com.neosukisu.neosukisu.ui.MainActivity")
        val alias = ComponentName(packageName, "com.neosukisu.neosukisu.ui.MainActivityAlias")
        application.packageManager.setComponentEnabledSetting(
