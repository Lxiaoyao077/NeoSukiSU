...
The application code is rooted at `com.neosukisu.neosukisu`.
...
Repository implementations belong under `com.neosukisu.neosukisu.data` and its subpackages. Keep
...
```text
com.neosukisu.neosukisu.ui.component
```
...
`com.neosukisu.neosukisu.ui.component.Dialog#rememberCustomDialog`,
if you need confirmDialog, use `com.neosukisu.neosukisu.ui.component.Dialog#rememberConfirmDialog`,
if you need loadingDialog, use `com.neosukisu.neosukisu.ui.component.Dialog#rememberLoadingDialog`
...
```text
com.neosukisu.neosukisu.ui.component.settings
```
...
```text
com.neosukisu.neosukisu.ui.component.settings.material3internal.AnimatedShape.kt
```
...
* Reusable components are under `com.neosukisu.neosukisu.ui.component`.
* Settings screens use `com.neosukisu.neosukisu.ui.component.settings` components.
